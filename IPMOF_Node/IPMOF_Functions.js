...
GLOBAL.car2frac = function(coor, UCsize, UCangle, fracVolume){
  var alp = degToRad(UCangle[0]);
	var bet = degToRad(UCangle[1]);
	var gam = degToRad(UCangle[2]);
...
GLOBAL.fracPBC = function(fracCoor){
  var pbcCoor = [];
...
GLOBAL.frac2car = function(coor, UCsize, UCangle, fracVolume){
	var alp = degToRad(UCangle[0]);
	var bet = degToRad(UCangle[1]);
	var gam = degToRad(UCangle[2]);
...
GLOBAL.coorDist = function(coor1, coor2){
...
GLOBAL.coorDiff = function(coor1, coor2){
  var coor3 = [coor2[0]-coor1[0], coor2[1]-coor1[1], coor2[2]-coor1[2]];
  return coor3;
};

GLOBAL.coorAdd = function(coor1, coor2){
  var coor3 = [coor2[0]+coor1[0], coor2[1]+coor1[1], coor2[2]+coor1[2]];
  return coor3;
};
